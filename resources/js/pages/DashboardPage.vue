  ...
  <div class="dashboard">
    ...
    <div class="sync-banner" v-if="syncStatus && (syncStatus.pending > 0 || syncStatus.percent < 100)">
      <div class="sync-banner-header">
        <div class="sync-banner-left">
          ...
          <span class="sync-badge">{{ syncStatus.pending }} job{{ syncStatus.pending > 1 ? 's' : '' }} en attente</span>
        </div>
    ...
    <transition name="toast">
      <div v-if="feedback" class="toast" :class="'toast-' + feedback.type">
        <svg v-if="feedback.type === 'success'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="toast-ico">
