  ...
  <div class="contacts-container">
      ...
      <div class="filters-grid">
        <div class="filter-group">
          ...
          <div class="input-icon">
            <svg class="input-icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
            </svg>
            <input v-model="filters.search" class="finput" placeholder="Conseiller, fonction..." @input="debouncedFetch"/>
          </div>
        </div>
        <div class="filter-group">
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="c in contacts" :key="c.id" class="table-row">
              ...
              <!-- Partenaire -->
              <td>
                <RouterLink v-if="c.partenaire" :to="`/partenaires/${c.partenaire_id}`" class="link-partenaire">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" class="link-ico">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21"/>
                  </svg>
                  {{ c.partenaire.raison_sociale }}
                </RouterLink>
              ...
              <td>
                <div v-if="c.date_rdv" class="date-cell">
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" class="cell-icon">
              ...
              <td>
                <div class="action-buttons">
                  <button class="action-btn edit" @click="openModal(c)" title="Modifier">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5" class="action-icon">
    ...
    <div class="pagination-container">
      <div class="pagination">
        <button
          v-for="(link, i) in pagination.links.filter(l => l.label !== null)"
          :key="i"
          class="page-btn"
...
"
    ...
    <ConfirmDialog v-if="showConfirm" message="Voulez-vous vraiment supprimer ce contact ?"
