<template>
    <div class="partenaires-container">
            ...
            <div class="filters-grid">
                <div class="filter-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input v-model="filters.search" class="input" placeholder="Raison sociale, contact..."
                ...
                <div class="filter-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input v-model="filters.ville" class="input" placeholder="Toutes les villes"
                            @input="debouncedFetch" />
                    </div>
                </div>
        ...
        <ConfirmDialog v-if="showConfirm" message="Voulez-vous vraiment supprimer ce partenaire ?" @confirm="doDelete"
...
async function fetchData(): Promise<void> {
    ...
    try {
        ...
        console.log('Données reçues:', result.data[0]) //
...
<style scoped src="./styles/partenaire.css"></style>
